        ...
        try (Statement st = connection.createStatement(); ResultSet rs = st.executeQuery(query)) {
            while (rs.next()) {
                ...
                if (rs.getObject("transporterId") != null) {
                    ...
                    TransportEXType transportType = TransportEXType.DHL; // Valeur par défaut
                    String transportTypeStr = rs.getString("transportType");
                    if (transportTypeStr != null) {
                        try {
                            transportType = TransportEXType.valueOf(transportTypeStr);
                    ...
                    if (rs.getObject("transporterId") != null) {
                        ...
                        if (transporterUser instanceof Transporter) {
                            ...
                            transporter = new Transporter(
                                    ...
                                    TransportEXType.DHL  // Default value
                            );
                        }
                    }
