...
public class TestCircuitCRUD {
    ...
    public static void main(String[] args) {
        ...
        vehicle1.setIdAgency(10);  // Make sure agency ID 1 exists
        vehicle2.setIdAgency(11);  // Make sure agency ID 1 exists
        ...
        // Ensure that the vehicles are added to the database before creating rentals
